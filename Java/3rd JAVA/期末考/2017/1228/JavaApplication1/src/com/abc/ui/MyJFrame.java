...
public class MyJFrame extends javax.swing.JFrame {
    ...
    private void openMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openMenuMouseClicked
        ...
        //(1)輸入查詢參數
        //=======================================
        String no = JOptionPane.showInputDialog(this, "請輸入學號");
        no = no.trim();
        ...
        try{
            ...
            //(2)產生一個SQL命令
            //=======================================    
            PreparedStatement stmt = connection.prepareStatement("select stuNo, stuName, gender, schNo\n" +
"from student \n" +
"where stuName like ?");
            ...
            do{
                ...
                String s2=rs.getString("schNo");

                //將取出的檔位產生一個陣列
                Object[] row = {stuNo, stuName, s1, s2};        
